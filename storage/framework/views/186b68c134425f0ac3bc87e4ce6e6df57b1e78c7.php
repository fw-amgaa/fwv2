            ...
            <div class="container entry-header-content">
                ...
                <div class="entry-meta align-items-center meta-2 font-small color-white">
                    <p class="mb-5 text-white">
                        <a class="author-avatar" href="#"><img class="img-circle" src="<?php echo e(Voyager::image($blog->image)); ?>" alt="">
                        </a>
                        By 
                        <a href="author.html">
                          <span class="author-name font-weight-bold text-white">
                            Barbara Cartland
                          </span>
                        </a>
                        <span class="author-name font-weight-bold text-white">
                ...
                <div class="entry-main-content dropcap wow fadeIn animated">
                    ...
                    <figure class="wp-block-gallery columns-3 wp-block-image">
                        <ul class="blocks-gallery-grid">
                            <li class="blocks-gallery-item"><a href="#"><img class="border-radius-5" src="http://via.placeholder.com/500x500" alt=""></a></li>
                            <li class="blocks-gallery-item"><a href="#"><img class="border-radius-5" src="http://via.placeholder.com/500x500" alt=""></a></li>
                            <li class="blocks-gallery-item"><a href="#"><img class="border-radius-5" src="http://via.placeholder.com/500x500" alt=""></a></li>
                        </ul>
                    ...
                    <div class="wp-block-image">
                        <figure class="alignleft is-resized">
                            <img class="border-radius-5" src="http://via.placeholder.com/200x300">
